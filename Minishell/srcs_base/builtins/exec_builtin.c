...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/06/25 12:35:44 by viaremko          #+#    #+#             */
/*   Updated: 2026/06/25 12:36:04 by viaremko         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static const t_builtin	*builtin_setup(void)
{
	static t_builtin	builtins[] = {{"echo", ft_echo}, {"cd", ft_cd}, {"pwd",
		ft_pwd}, {"export", ft_export}, {"unset", ft_unset}, {"env",
		ft_env}, {"exit", ft_exit}, {NULL, NULL}};
